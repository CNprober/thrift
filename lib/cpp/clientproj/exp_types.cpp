...
const std::map<int, const char*> _TweetType_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(5, _kTweetTypeValues, _kTweetTypeNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
